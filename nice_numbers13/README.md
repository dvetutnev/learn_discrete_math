...
* Числа составлены из чисел
* Суммирование чисел/цифр в число

Базовый объект - цифра. Операции с ним:

* Сложение (с переносом)
* Сравнение больше/меньше
* Проверка на равенство

Из цифр собираются цифры. Операции:

* Построение из цифр
* Сравнение на равенство
* Сложение
* И для упрощения решения задачки введем операцию доступа ко всем разрядам числа
